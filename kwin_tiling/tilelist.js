...
TileList._isIgnored = function(client) {
	...
	var fl = "vlc,yakuake,krunner,plasma,plasma-desktop,plugin-container,Wine,klipper,plasmashell,Plasma,ksmserver,pinentry,frame,frame1,frame2,frame3,frame4,frame5,display,gimp,Gimp";
	...
	//var floaters = String(KWin.readConfig("floaters", fl)).replace(/ /g,"").split(",");
        var floaters = String(fl).replace(/ /g,"").split(",");
